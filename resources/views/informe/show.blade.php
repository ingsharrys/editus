...
<div class="max-w-6xl mx-auto px-4 py-8">
    ...
    @php
        ...
        $pageSummary = $posts->groupBy(fn ($p) => $p->page->name ?? '—')
            ->map(function ($group) {
                return (object) [
            ...
            <table class="min-w-full text-sm">
                ...
                <tfoot>
                    <tr class="font-semibold">
                        ...
                        <td class="py-2 pr-4 text-right">{{ number_format((int) ($summary['visualizaciones_sum'] ?? 0)) }}</td>
                        <td class="py-2 pr-4 text-right">{{ number_format((int) ($summary['interacciones_sum'] ?? 0)) }}</td>
...
@section('scripts')
    ...
    <script>
        (function () {
            ...
            const byPage = @json($chartByPage); // { labels: [...], datasets: { Alcance:[...], Visualizaciones:[...], Interacciones:[...] } }
